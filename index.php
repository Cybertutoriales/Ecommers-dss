			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Envio PAGO CONTRA ENTREGA gratis</h4>
						</div>
					</div>
					<h6 class="text">envio gratis en pedidos mayores a Q.600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Mujeres</a></li>
					<li><a href="#books" data-toggle="tab">Hogar</a></li>
					<li><a href="#furniture" data-toggle="tab">Hombre</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Faldas</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													Q. <?php echo htmlentities($row['productPrice']);?>
												</span>
