...
<h3>Tienda Virtual DSS</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> TIENDA VIRTUAL DSS version DEMO</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+502) 45185316<br>(+502) 45239449</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">clientesdss.esc@gmail.com</a></span>
                </div>
            </li>
